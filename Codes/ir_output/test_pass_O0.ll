; ModuleID = 'test_pass.c'
source_filename = "test_pass.c"
...
define dso_local i32 @main() #0 {
  ...
  %9 = call i32 (ptr, ...) @printf(ptr noundef @"??_C@_03PMGGPEJJ@?$CFd?6?$AA@", i32 noundef %8)
  ret i32 0
}
...
!1 = !DIFile(filename: "test_pass.c", directory: "F:\\My Files\\NIT Warangal\\Semester IV\\CLG Work or Project\\Compiler Design")
